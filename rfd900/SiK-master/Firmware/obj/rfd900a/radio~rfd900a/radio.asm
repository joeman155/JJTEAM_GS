...
;--------------------------------------------------------
	.area DSEG    (DATA)
_radio_receive_packet_crc1_1_137:
	.ds 2
_radio_transmit_golay_elen_1_188:
	.ds 1
;--------------------------------------------------------
...
_preamble_detected:
	.ds 1
_radio_preamble_detected_EX0_saved_1_159:
	.ds 1
_radio_transmit_simple_transmit_started_1_172:
	.ds 1
_radio_transmit_golay_sloc0_1_0:
	.ds 1
_radio_transmit_EX0_saved_1_191:
	.ds 1
...
_scale_uint32_PARM_2:
	.ds 4
_scale_uint32_value_1_250:
	.ds 4
_set_frequency_registers_frequency_1_258:
	.ds 4
;--------------------------------------------------------
; external ram data
;--------------------------------------------------------
...
_radio_buffer::
	.ds 252
_radio_receive_packet_length_1_136:
	.ds 3
_radio_receive_packet_gout_1_137:
	.ds 3
_radio_transmit_golay_length_1_187:
	.ds 1
_radio_transmit_golay_gin_1_188:
	.ds 3
_radio_transmit_length_1_190:
	.ds 1
_radio_set_channel_channel_1_208:
	.ds 1
_radio_set_transmit_power_power_1_232:
	.ds 1
_radio_set_network_id_id_1_238:
	.ds 2
_set_frequency_registers_band_1_259:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;crc1                      Allocated with name '_radio_receive_packet_crc1_1_137'
;crc2                      Allocated to registers r5 r7 
;errcount                  Allocated to registers r6 
;elen                      Allocated to registers r7 
;length                    Allocated with name '_radio_receive_packet_length_1_136'
;gout                      Allocated with name '_radio_receive_packet_gout_1_137'
;------------------------------------------------------------
...
_radio_receive_packet:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_radio_receive_packet_length_1_136
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;	radio/radio.c:126: errcount = golay_decode(6, buf, gout);
	...
	mov	a,#_radio_receive_packet_gout_1_137
	movx	@r0,a
	inc	r0
	mov	a,#(_radio_receive_packet_gout_1_137 >> 8)
	movx	@r0,a
	mov	dpl,#0x06
	push	ar7
	lcall	_golay_decode
...
;	radio/radio.c:127: if (gout[0] != netid[0] ||
	mov	dptr,#_radio_receive_packet_gout_1_137
	movx	a,@dptr
	mov	r5,a
	mov	r0,#_netid
	movx	a,@r0
...
;	radio/radio.c:128: gout[1] != netid[1]) {
	mov	dptr,#(_radio_receive_packet_gout_1_137 + 0x0001)
	movx	a,@dptr
	mov	r5,a
...
;	radio/radio.c:136: if (6*((gout[2]+2)/3+2) != elen) {
	mov	dptr,#(_radio_receive_packet_gout_1_137 + 0x0002)
	movx	a,@dptr
	mov	r5,a
	mov	r4,#0x00
	mov	a,#0x02
...
;	radio/radio.c:145: crc1 = gout[0] | (((uint16_t)gout[1])<<8);
	...
	mov	r2,a
	orl	a,r5
	mov	_radio_receive_packet_crc1_1_137,a
	mov	a,r3
	orl	a,r2
	mov	(_radio_receive_packet_crc1_1_137 + 1),a
...
;	radio/radio.c:155: if (crc1 != crc2) {
	mov	a,r5
	cjne	a,_radio_receive_packet_crc1_1_137,00126$
	mov	a,r7
	cjne	a,(_radio_receive_packet_crc1_1_137 + 1),00126$
...
;	radio/radio.c:230: EX0_SAVE_DISABLE;
	mov	c,_EX0
	mov	_radio_preamble_detected_EX0_saved_1_159,c
	clr	_EX0
...
;	radio/radio.c:233: EX0_RESTORE;
	mov	c,_radio_preamble_detected_EX0_saved_1_159
	mov	_EX0,c
...
;	radio/radio.c:326: transmit_started = false;
	clr	_radio_transmit_simple_transmit_started_1_172
...
;	radio/radio.c:338: if (transmit_started && length != 0 && (status & EZRADIOPRO_ITXFFAEM)) {
	jnb	_radio_transmit_simple_transmit_started_1_172,00108$
	mov	a,r7
	jz	00108$
	mov	a,r3
	jnb	acc.5,00108$
...
;	radio/radio.c:354: if (transmit_started && length != 0 && (status & EZRADIOPRO_ITXFFAFULL) == 0) {
	jnb	_radio_transmit_simple_transmit_started_1_172,00114$
	mov	a,r7
	jz	00114$
	mov	a,r3
	jb	acc.6,00114$
...
;	radio/radio.c:383: transmit_started = true;
	setb	_radio_transmit_simple_transmit_started_1_172
;	radio/radio.c:384: continue;
	ljmp	00130$
00122$:
;	radio/radio.c:386: if (transmit_started && (status & 0x02) == 0) {
	jb	_radio_transmit_simple_transmit_started_1_172,00214$
	ljmp	00130$
00214$:
	mov	a,r3
	jnb	acc.1,00215$
...
;------------------------------------------------------------
;elen                      Allocated with name '_radio_transmit_golay_elen_1_188'
;rlen                      Allocated to registers r5 
;length                    Allocated with name '_radio_transmit_golay_length_1_187'
;gin                       Allocated with name '_radio_transmit_golay_gin_1_188'
;------------------------------------------------------------
...
;	radio/radio.c:430: if (length > (sizeof(radio_buffer)/2)-6) {
	mov	dptr,#_radio_transmit_golay_length_1_187
	movx	@dptr,a
	mov  r7,a
	add	a,#0xff - 0x78
	jnc	00102$
...
;	radio/radio.c:439: elen = (rlen+6)*2;
	...
	add	a,#0x06
	add	a,acc
	mov	_radio_transmit_golay_elen_1_188,a
;	radio/radio.c:442: gin[0] = netid[0];
	mov	r0,#_netid
	movx	a,@r0
	mov	dptr,#_radio_transmit_golay_gin_1_188
	movx	@dptr,a
;	radio/radio.c:443: gin[1] = netid[1];
	mov	r0,#(_netid + 0x0001)
	movx	a,@r0
	mov	dptr,#(_radio_transmit_golay_gin_1_188 + 0x0001)
	movx	@dptr,a
;	radio/radio.c:444: gin[2] = length;
	mov	dptr,#(_radio_transmit_golay_gin_1_188 + 0x0002)
	mov	a,r7
	movx	@dptr,a
;	radio/radio.c:447: golay_encode(3, gin, radio_buffer);
	mov	r0,#_golay_encode_PARM_2
	mov	a,#_radio_transmit_golay_gin_1_188
	movx	@r0,a
	inc	r0
	mov	a,#(_radio_transmit_golay_gin_1_188 >> 8)
	movx	@r0,a
...
;	radio/radio.c:462: return radio_transmit_simple(elen, radio_buffer, timeout_ticks);
	...
	inc	r1
	movx	@r1,a
	mov	dpl,_radio_transmit_golay_elen_1_188
...
;------------------------------------------------------------
;length                    Allocated with name '_radio_transmit_length_1_190'
;------------------------------------------------------------
...
_radio_transmit:
	mov	a,dpl
	mov	dptr,#_radio_transmit_length_1_190
	movx	@dptr,a
;	radio/radio.c:477: EX0_SAVE_DISABLE;
	mov	c,_EX0
	mov	_radio_transmit_EX0_saved_1_191,c
	clr	_EX0
;	radio/radio.c:480: PA_ENABLE = 1;		// Set PA_Enable to turn on PA prior to TX cycle
	setb	_PA_ENABLE
...
;	radio/radio.c:486: ret = radio_transmit_golay(length, buf, timeout_ticks);
	...
	mov	_radio_transmit_sloc0_1_0,c
00103$:
;	radio/radio.c:489: PA_ENABLE = 0;		// Set PA_Enable to off the PA after TX cycle
	clr	_PA_ENABLE
;	radio/radio.c:491: EX0_RESTORE;
	mov	c,_radio_transmit_EX0_saved_1_191
	mov	_EX0,c
...
;------------------------------------------------------------
;status                    Allocated with name '_radio_initialise_status_1_197'
;------------------------------------------------------------
...
;------------------------------------------------------------
;channel                   Allocated with name '_radio_set_channel_channel_1_208'
;------------------------------------------------------------
...
_radio_set_channel:
	mov	a,dpl
	mov	dptr,#_radio_set_channel_channel_1_208
	movx	@dptr,a
...
;------------------------------------------------------------
;power                     Allocated with name '_radio_set_transmit_power_power_1_232'
;i                         Allocated with name '_radio_set_transmit_power_i_1_233'
;------------------------------------------------------------
...
_radio_set_transmit_power:
	mov	a,dpl
	mov	dptr,#_radio_set_transmit_power_power_1_232
	movx	@dptr,a
;	radio/radio.c:889: register_write(EZRADIOPRO_TX_POWER, 6); // Set output power of Si1002 to 6 = +10dBm as a nominal level
	mov	a,#0x06
	push	acc
	mov	dpl,#0x6D
	lcall	_register_write
	dec	sp
;	radio/radio.c:890: i = calibration_get(power);
	mov	dptr,#_radio_set_transmit_power_power_1_232
	movx	a,@dptr
	mov	r7,a
	mov	dpl,a
	...
	mov	r6,dpl
	pop	ar7
;	radio/radio.c:891: if (i != 0xFF)
	cjne	r6,#0xFF,00109$
	sjmp	00102$
00109$:
;	radio/radio.c:893: PCA0CPH0 = i;     // Set PWM for PA to correct duty cycle
	mov	_PCA0CPH0,r6
;	radio/radio.c:894: settings.transmit_power = power;
	mov	r0,#(_settings + 0x000a)
	mov	a,r7
	movx	@r0,a
	ret
00102$:
;	radio/radio.c:898: i = power / POWER_LEVEL_STEP;
	mov	a,r7
	clr	c
	rrc	a
;	radio/radio.c:899: PCA0CPH0 = power_levels[i];     // Set PWM for PA to correct duty cycle
	mov	r7,a
	mov	dptr,#_power_levels
	movc	a,@a+dptr
	mov	_PCA0CPH0,a
;	radio/radio.c:900: settings.transmit_power = i * POWER_LEVEL_STEP;
	mov	a,r7
	add	a,r7
	mov	r7,a
	mov	r0,#(_settings + 0x000a)
...
;------------------------------------------------------------
;id                        Allocated with name '_radio_set_network_id_id_1_238'
;------------------------------------------------------------
...
_radio_set_network_id:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_radio_set_network_id_id_1_238
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
_scale_uint32:
	...
	mov	r5,b
	mov	r4,a
	mov	r0,#_scale_uint32_value_1_250
	mov	a,r7
	movx	@r0,a
	inc	r0
	mov	a,r6
...
;------------------------------------------------------------
;status                    Allocated with name '_software_reset_status_1_253'
;------------------------------------------------------------
...
;------------------------------------------------------------
;band                      Allocated with name '_set_frequency_registers_band_1_259'
;------------------------------------------------------------
...
_set_frequency_registers:
	...
	mov	r5,b
	mov	r4,a
	mov	r0,#_set_frequency_registers_frequency_1_258
	mov	a,r7
	movx	@r0,a
	inc	r0
	mov	a,r6
...
;	radio/radio.c:1087: frequency -= 480000000UL;
	mov	r0,#(_set_frequency_registers_frequency_1_258 + 1)
	movx	a,@r0
	add	a,#0xC8
	movx	@r0,a
	inc	r0
...
;	radio/radio.c:1088: band  = frequency / 20000000UL;
	...
	lcall	__divulong
	mov	r2,dpl
	mov	dptr,#_set_frequency_registers_band_1_259
	mov	a,r2
	movx	@dptr,a
