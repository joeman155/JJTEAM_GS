...
_printf_start_capture_PARM_2:
	.ds 1
_printf_start_capture_buf_1_122:
	.ds 2
;--------------------------------------------------------
...
;buf                       Allocated with name '_printf_start_capture_buf_1_122'
;------------------------------------------------------------
...
_printf_start_capture:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_printf_start_capture_buf_1_122
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;buffer                    Allocated with name '_vprintfl_buffer_4_141'
;------------------------------------------------------------
