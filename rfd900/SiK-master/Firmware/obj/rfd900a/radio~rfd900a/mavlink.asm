...
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
_mavlink_crc_length_1_136:
	.ds 1
_mavlink_crc_tmp_2_138:
	.ds 1
...
;------------------------------------------------------------
;length                    Allocated with name '_mavlink_crc_length_1_136'
;tmp                       Allocated with name '_mavlink_crc_tmp_2_138'
...
;------------------------------------------------------------
;i                         Allocated with name '_swap_bytes_i_1_140'
;tmp                       Allocated with name '_swap_bytes_tmp_2_141'
;------------------------------------------------------------
...
;	radio/mavlink.c:123: pbuf[i+1] = tmp;
	mov	dpl,r2
	mov	dph,r3
	mov	a,_swap_bytes_tmp_2_141
	movx	@dptr,a
;	radio/mavlink.c:120: for (i=ofs; i<ofs+len; i+=2) {
	inc	_swap_bytes_i_1_140
	inc	_swap_bytes_i_1_140
	sjmp	00103$
00105$:
	ret
...
;m                         Allocated with name '_MAVLink_report_m_2_144'
;m                         Allocated with name '_MAVLink_report_m_2_145'
;------------------------------------------------------------
