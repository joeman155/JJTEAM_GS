...
;--------------------------------------------------------
	.area DSEG    (DATA)
_mavlink_frame_slen_1_140:
	.ds 2
_mavlink_frame_c_2_141:
	.ds 1
_mavlink_frame_sloc0_1_0:
	.ds 1
_mavlink_frame_sloc1_1_0:
	.ds 2
_packet_get_next_max_xmit_1_145:
	.ds 1
_packet_get_next_slen_1_146:
	.ds 2
...
_last_sent:
	.ds 252
_mavlink_frame_max_xmit_1_139:
	.ds 1
_packet_set_max_xmit_max_1_177:
	.ds 1
_packet_set_serial_speed_speed_1_179:
	.ds 2
_packet_is_duplicate_len_1_181:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;slen                      Allocated with name '_mavlink_frame_slen_1_140'
;c                         Allocated with name '_mavlink_frame_c_2_141'
;sloc0                     Allocated with name '_mavlink_frame_sloc0_1_0'
;sloc1                     Allocated with name '_mavlink_frame_sloc1_1_0'
;max_xmit                  Allocated with name '_mavlink_frame_max_xmit_1_139'
;------------------------------------------------------------
...
_mavlink_frame:
	mov	a,dpl
	mov	dptr,#_mavlink_frame_max_xmit_1_139
	movx	@dptr,a
...
;	radio/packet.c:110: slen = serial_read_available();
	...
	mov	_mavlink_frame_slen_1_140,dpl
	mov	(_mavlink_frame_slen_1_140 + 1),dph
...
00109$:
	clr	c
	mov	a,_mavlink_frame_slen_1_140
	subb	a,#0x08
	mov	a,(_mavlink_frame_slen_1_140 + 1)
	subb	a,#0x00
	jnc	00135$
	ljmp	00111$
00135$:
;	radio/packet.c:115: register uint8_t c = serial_peek();
	lcall	_serial_peek
	mov	_mavlink_frame_c_2_141,dpl
;	radio/packet.c:116: if (c != MAVLINK09_STX && c != MAVLINK10_STX) {
	mov	a,#0x55
	cjne	a,_mavlink_frame_c_2_141,00136$
	sjmp	00102$
00136$:
	mov	a,#0xFE
	cjne	a,_mavlink_frame_c_2_141,00137$
	sjmp	00102$
00137$:
...
;	radio/packet.c:121: if (c >= 255 - 8 || 
	mov	a,#0x100 - 0xF7
	add	a,_mavlink_frame_c_2_141
	jnc	00138$
	ljmp	00111$
00138$:
;	radio/packet.c:122: c+8 > max_xmit - last_sent_len) {
	mov	r2,_mavlink_frame_c_2_141
	mov	r3,#0x00
	mov	a,#0x08
	add	a,r2
	mov	r6,a
...
;	radio/packet.c:141: slen -= c;
	mov	r4,_mavlink_frame_c_2_141
	mov	r7,#0x00
	mov	a,_mavlink_frame_slen_1_140
	clr	c
	subb	a,r4
	mov	_mavlink_frame_slen_1_140,a
	mov	a,(_mavlink_frame_slen_1_140 + 1)
	subb	a,r7
	mov	(_mavlink_frame_slen_1_140 + 1),a
	ljmp	00109$
00111$:
...
;------------------------------------------------------------
;max_xmit                  Allocated with name '_packet_get_next_max_xmit_1_145'
;slen                      Allocated with name '_packet_get_next_slen_1_146'
...
;	-----------------------------------------
_packet_get_next:
	mov	_packet_get_next_max_xmit_1_145,dpl
;	radio/packet.c:154: slen = serial_read_available();
	lcall	_serial_read_available
	mov	_packet_get_next_slen_1_146,dpl
	mov	(_packet_get_next_slen_1_146 + 1),dph
...
;	radio/packet.c:159: slen < PACKET_RESEND_THRESHOLD)) {
	clr	c
	mov	a,_packet_get_next_slen_1_146
	subb	a,#0x20
	mov	a,(_packet_get_next_slen_1_146 + 1)
	subb	a,#0x00
	jnc	00104$
00103$:
;	radio/packet.c:160: if (max_xmit < last_sent_len) {
	...
	movx	a,@r0
	mov	b,a
	mov	a,_packet_get_next_max_xmit_1_145
	subb	a,b
	jnc	00102$
...
;	radio/packet.c:167: slen = last_sent_len;
	mov	r0,#_last_sent_len
	movx	a,@r0
	mov	_packet_get_next_slen_1_146,a
	mov	(_packet_get_next_slen_1_146 + 1),#0x00
;	radio/packet.c:168: last_sent_len = 0;
	mov	r0,#_last_sent_len
	clr	a
	movx	@r0,a
;	radio/packet.c:169: return (slen & 0xFF);
	mov	r3,_packet_get_next_slen_1_146
	mov	dpl,r3
	ret
00104$:
...
;	radio/packet.c:176: slen = last_sent_len;
	...
	mov	r3,a
	mov	r4,#0x00
	mov	_packet_get_next_slen_1_146,r3
	mov	(_packet_get_next_slen_1_146 + 1),r4
;	radio/packet.c:177: if (max_xmit < slen) {
	mov	_packet_get_next_sloc0_1_0,_packet_get_next_max_xmit_1_145
	mov	(_packet_get_next_sloc0_1_0 + 1),#0x00
	clr	c
	mov	a,_packet_get_next_sloc0_1_0
	subb	a,_packet_get_next_slen_1_146
	mov	a,(_packet_get_next_sloc0_1_0 + 1)
	subb	a,(_packet_get_next_slen_1_146 + 1)
	jnc	00110$
...
;	radio/packet.c:180: memcpy(last_sent, &last_sent[max_xmit], slen - max_xmit);
	...
	inc	dptr
	movx	@dptr,a
	mov	r6,_packet_get_next_max_xmit_1_145
	mov	r7,#0x00
	mov	dptr,#_memcpy_PARM_3
	mov	a,_packet_get_next_slen_1_146
	clr	c
...
;	radio/packet.c:197: slen = max_xmit;
	mov	_packet_get_next_slen_1_146,r6
	mov	(_packet_get_next_slen_1_146 + 1),r7
00114$:
...
;	radio/packet.c:202: if (slen == 0) {
	mov	a,_packet_get_next_slen_1_146
	orl	a,(_packet_get_next_slen_1_146 + 1)
...
;	radio/packet.c:209: if (slen > 0 && serial_read_buf(buf, slen)) {
	...
	orl	a,(_packet_get_next_slen_1_146 + 1)
	jz	00118$
	mov	r5,_packet_get_next_slen_1_146
	mov	r0,#_serial_read_buf_PARM_2
	mov	a,r5
	movx	@r0,a
	mov	r0,#_packet_get_next_PARM_2
...
;	radio/packet.c:222: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_146,00250$
	clr	a
	cjne	a,(_packet_get_next_slen_1_146 + 1),00250$
	sjmp	00251$
00250$:
	sjmp	00126$
00251$:
...
;	radio/packet.c:262: if (slen == 1) {
	mov	a,#0x01
	cjne	a,_packet_get_next_slen_1_146,00260$
	clr	a
	cjne	a,(_packet_get_next_slen_1_146 + 1),00260$
	sjmp	00261$
00260$:
	sjmp	00138$
00261$:
...
;	radio/packet.c:280: slen--;				
	dec	_packet_get_next_slen_1_146
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_146,00266$
	dec	(_packet_get_next_slen_1_146 + 1)
00266$:
...
;	radio/packet.c:309: slen--;
	dec	_packet_get_next_slen_1_146
	mov	a,#0xFF
	cjne	a,_packet_get_next_slen_1_146,00269$
	dec	(_packet_get_next_slen_1_146 + 1)
00269$:
	ljmp	00152$
00154$:
...
;------------------------------------------------------------
;max                       Allocated with name '_packet_set_max_xmit_max_1_177'
;------------------------------------------------------------
...
;	radio/packet.c:344: mav_max_xmit = max;
	mov	dptr,#_packet_set_max_xmit_max_1_177
	movx	@dptr,a
	mov	r0,#_mav_max_xmit
	movx	@r0,a
	ret
...
;------------------------------------------------------------
;speed                     Allocated with name '_packet_set_serial_speed_speed_1_179'
;------------------------------------------------------------
...
_packet_set_serial_speed:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_packet_set_serial_speed_speed_1_179
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;len                       Allocated with name '_packet_is_duplicate_len_1_181'
;------------------------------------------------------------
...
_packet_is_duplicate:
	mov	a,dpl
	mov	dptr,#_packet_is_duplicate_len_1_181
	movx	@dptr,a
