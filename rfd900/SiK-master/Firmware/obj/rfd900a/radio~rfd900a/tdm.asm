...
; This file was generated Sun Nov 24 17:43:11 2013
;--------------------------------------------------------
	.module tdm
...
_tdm_show_rssi_sloc4_1_0:
	.ds 2
_sync_tx_windows_old_state_1_157:
	.ds 1
...
_remote_at_cmd:
	.ds 17
_sync_tx_windows_delta_2_164:
	.ds 2
_tdm_serial_loop_last_t_1_209:
	.ds 2
_tdm_serial_loop_last_link_update_1_209:
	.ds 2
_tdm_serial_loop_len_2_210:
	.ds 1
_tdm_serial_loop_tdelta_2_210:
	.ds 2
;--------------------------------------------------------
; external ram data
;--------------------------------------------------------
...
_pbuf::
	.ds 252
_link_update_unlock_count_1_187:
	.ds 1
_link_update_temperature_count_1_187:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;old_state                 Allocated with name '_sync_tx_windows_old_state_1_157'
;------------------------------------------------------------
...
;	radio/tdm.c:206: __data enum tdm_state old_state = tdm_state;
	mov	r0,#_tdm_state
	movx	a,@r0
	mov	_sync_tx_windows_old_state_1_157,a
...
;	radio/tdm.c:212: if (old_state == TDM_SILENCE1) {
	mov	a,#0x01
	cjne	a,_sync_tx_windows_old_state_1_157,00106$
...
;	radio/tdm.c:219: } else if (old_state == TDM_RECEIVE || old_state == TDM_SILENCE2) {
	mov	a,#0x02
	cjne	a,_sync_tx_windows_old_state_1_157,00151$
	sjmp	00101$
00151$:
	mov	a,#0x03
	cjne	a,_sync_tx_windows_old_state_1_157,00102$
00101$:
...
;	radio/tdm.c:248: delta = old_remaining - tdm_state_remaining;
	mov	r0,#_tdm_state_remaining
	mov	r1,#_sync_tx_windows_delta_2_164
	setb	c
	movx	a,@r0
	subb	a,r4
	cpl	a
...
;	radio/tdm.c:249: if (old_state != tdm_state ||
	mov	r0,#_tdm_state
	movx	a,@r0
	cjne	a,_sync_tx_windows_old_state_1_157,00113$
;	radio/tdm.c:250: delta > (int16_t)packet_latency/2 ||
	...
	pop	ar2
	pop	ar3
	mov	r0,#_sync_tx_windows_delta_2_164
	clr	c
	movx	a,@r0
	mov	b,a
	mov	a,r6
...
;	radio/tdm.c:252: printf("TDM: %u/%u len=%u ",
	...
	mov	r2,a
	mov	r3,#0x00
	mov	r4,_sync_tx_windows_old_state_1_157
	mov	r5,#0x00
	push	ar7
	push	ar6
	push	ar2
...
;unlock_count              Allocated with name '_link_update_unlock_count_1_187'
;temperature_count         Allocated with name '_link_update_temperature_count_1_187'
;------------------------------------------------------------
...
;	radio/tdm.c:369: unlock_count = 0;
	mov	dptr,#_link_update_unlock_count_1_187
	clr	a
	movx	@dptr,a
...
;	radio/tdm.c:427: temperature_count++;
	mov	dptr,#_link_update_temperature_count_1_187
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
...
;	radio/tdm.c:484: __pdata uint16_t last_t = timer2_tick();
	lcall	_timer2_tick
	mov	r0,#_tdm_serial_loop_last_t_1_209
	mov	a,dpl
	movx	@r0,a
	inc	r0
	mov	a,dph
...
;	radio/tdm.c:485: __pdata uint16_t last_link_update = last_t;
	mov	r0,#_tdm_serial_loop_last_t_1_209
	mov	r1,#_tdm_serial_loop_last_link_update_1_209
	movx	a,@r0
	movx	@r1,a
	inc	r0
	movx	a,@r0
...
;	radio/tdm.c:523: if (radio_receive_packet(&len, pbuf)) {
	...
	mov	a,#(_pbuf >> 8)
	movx	@r0,a
	mov	dptr,#_tdm_serial_loop_len_2_210
	mov	b,#0x60
	push	ar3
	push	ar2
...
;	radio/tdm.c:537: if (len < 2) {
	mov	r0,#_tdm_serial_loop_len_2_210
	movx	a,@r0
	cjne	a,#0x02,00347$
00347$:
	jnc	00348$
...
;	radio/tdm.c:582: tdelta = tnow - last_t;
	mov	r0,#_tdm_serial_loop_last_t_1_209
	mov	r1,#_tdm_serial_loop_tdelta_2_210
	setb	c
	movx	a,@r0
	subb	a,r2
	cpl	a
...
;	radio/tdm.c:583: tdm_state_update(tdelta);
	mov	r0,#_tdm_serial_loop_tdelta_2_210
	movx	a,@r0
	mov	dpl,a
	inc	r0
	movx	a,@r0
...
;	radio/tdm.c:587: if (tnow - last_link_update > 32768) {
	mov	r0,#_tdm_serial_loop_last_link_update_1_209
	setb	c
	movx	a,@r0
	subb	a,r2
	cpl	a
