...
; This file was generated Sun Nov 24 17:43:07 2013
;--------------------------------------------------------
	.module serial
...
;--------------------------------------------------------
	.area DSEG    (DATA)
_serial_write_buf_buf_1_153:
	.ds 2
_serial_read_buf_buf_1_177:
	.ds 2
;--------------------------------------------------------
...
_serial_write_buf_sloc0_1_0:
	.ds 1
_serial_write_space_ES_saved_1_165:
	.ds 1
_serial_read_ES_saved_1_169:
	.ds 1
_serial_peek_ES_saved_1_174:
	.ds 1
_serial_peek2_ES_saved_1_176:
	.ds 1
_serial_read_buf_sloc0_1_0:
	.ds 1
_serial_read_available_ES_saved_1_185:
	.ds 1
;--------------------------------------------------------
...
_serial_read_buf_PARM_2:
	.ds 1
_serial_read_buf_n1_1_178:
	.ds 2
;--------------------------------------------------------
; external ram data
;--------------------------------------------------------
	.area XSEG    (XDATA)
_serial_device_set_speed_i_1_195:
	.ds 1
;--------------------------------------------------------
...
;	radio/serial.c:109: if (at_mode_active) {
	jnb	_at_mode_active,00112$
;	radio/serial.c:111: if (!at_cmd_ready) {
	jnb	_at_cmd_ready,00149$
	ljmp	00115$
00149$:
...
;------------------------------------------------------------
;buf                       Allocated with name '_serial_write_buf_buf_1_153'
;------------------------------------------------------------
...
;	-----------------------------------------
_serial_write_buf:
	mov	_serial_write_buf_buf_1_153,dpl
	mov	(_serial_write_buf_buf_1_153 + 1),dph
...
;	radio/serial.c:260: memcpy(&tx_buf[tx_insert], buf, n1);
	...
	mov	a,_serial_write_buf_buf_1_153
	movx	@dptr,a
	mov	a,(_serial_write_buf_buf_1_153 + 1)
	inc	dptr
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	radio/serial.c:261: buf += n1;
	mov	a,r5
	add	a,_serial_write_buf_buf_1_153
	mov	_serial_write_buf_buf_1_153,a
	clr	a
	addc	a,(_serial_write_buf_buf_1_153 + 1)
	mov	(_serial_write_buf_buf_1_153 + 1),a
...
;	radio/serial.c:285: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_write_space_ES_saved_1_165,c
	clr	_ES0
...
;	radio/serial.c:287: ES0_RESTORE;
	mov	c,_serial_write_space_ES_saved_1_165
	mov	_ES0,c
...
;	radio/serial.c:310: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_ES_saved_1_169,c
	clr	_ES0
...
;	radio/serial.c:324: ES0_RESTORE;
	mov	c,_serial_read_ES_saved_1_169
	mov	_ES0,c
...
;	radio/serial.c:334: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peek_ES_saved_1_174,c
	clr	_ES0
...
;	radio/serial.c:336: ES0_RESTORE;
	mov	c,_serial_peek_ES_saved_1_174
	mov	_ES0,c
...
;	radio/serial.c:346: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_peek2_ES_saved_1_176,c
	clr	_ES0
...
;	radio/serial.c:348: ES0_RESTORE;
	mov	c,_serial_peek2_ES_saved_1_176
	mov	_ES0,c
...
;------------------------------------------------------------
;buf                       Allocated with name '_serial_read_buf_buf_1_177'
;------------------------------------------------------------
...
;	-----------------------------------------
_serial_read_buf:
	mov	_serial_read_buf_buf_1_177,dpl
	mov	(_serial_read_buf_buf_1_177 + 1),dph
...
;	radio/serial.c:366: n1 = count;
	mov	r0,#_serial_read_buf_n1_1_178
	mov	a,r2
	movx	@r0,a
	inc	r0
	mov	a,r3
...
;	radio/serial.c:368: n1 = sizeof(rx_buf) - rx_remove;
	mov	r0,#_rx_remove
	mov	r1,#_serial_read_buf_n1_1_178
	setb	c
	movx	a,@r0
	subb	a,#0x00
	cpl	a
...
;	radio/serial.c:370: memcpy(buf, &rx_buf[rx_remove], n1);
	mov	r2,_serial_read_buf_buf_1_177
	mov	r3,(_serial_read_buf_buf_1_177 + 1)
	mov	r7,#0x00
	mov	r0,#_rx_remove
	movx	a,@r0
	add	a,#_rx_buf
...
;	radio/serial.c:372: buf += n1;
	mov	r0,#_serial_read_buf_n1_1_178
	movx	a,@r0
	add	a,_serial_read_buf_buf_1_177
	mov	_serial_read_buf_buf_1_177,a
	inc	r0
	movx	a,@r0
	addc	a,(_serial_read_buf_buf_1_177 + 1)
	mov	(_serial_read_buf_buf_1_177 + 1),a
;	radio/serial.c:376: }
...
;	radio/serial.c:379: memcpy(buf, &rx_buf[0], count);
	mov	r5,_serial_read_buf_buf_1_177
	mov	r6,(_serial_read_buf_buf_1_177 + 1)
	mov	r7,#0x00
	mov	dptr,#_memcpy_PARM_2
	mov	a,#_rx_buf
	movx	@dptr,a
...
;	radio/serial.c:399: ES0_SAVE_DISABLE;
	mov	c,_ES0
	mov	_serial_read_available_ES_saved_1_185,c
	clr	_ES0
...
;	radio/serial.c:401: ES0_RESTORE;
	mov	c,_serial_read_available_ES_saved_1_185
	mov	_ES0,c
...
;------------------------------------------------------------
;space                     Allocated with name '_serial_read_space_space_1_187'
;------------------------------------------------------------
...
;------------------------------------------------------------
;i                         Allocated with name '_serial_device_valid_speed_i_1_191'
;num_rates                 Allocated with name '_serial_device_valid_speed_num_rates_1_191'
;speed                     Allocated to registers r7 
;------------------------------------------------------------
...
;------------------------------------------------------------
;speed                     Allocated to registers r7 
;i                         Allocated with name '_serial_device_set_speed_i_1_195'
;num_rates                 Allocated with name '_serial_device_set_speed_num_rates_1_195'
;------------------------------------------------------------
...
;	radio/serial.c:468: for (i = 0; i < num_rates; i++) {
	...
	sjmp	00107$
00115$:
	mov	dptr,#_serial_device_set_speed_i_1_195
	mov	a,r6
	movx	@dptr,a
