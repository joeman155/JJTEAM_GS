   ...
   02F5                     592 _cout:
                     ...
                     0001   599 	ar1 = 0x01
                     0000   600 	ar0 = 0x00
   02F5 AF 82         [24]  601 	mov	r7,dpl
                            602 ;	bootloader/util.c:48: while (!TI0)
   02F7                     603 00101$:
                            604 ;	bootloader/util.c:50: TI0 = 0;
   02F7 10 99 02      [24]  605 	jbc	_TI0,00112$
   02FA 80 FB         [24]  606 	sjmp	00101$
   02FC                     607 00112$:
                            608 ;	bootloader/util.c:51: SBUF0 = c;
   02FC 8F 99         [24]  609 	mov	_SBUF0,r7
   02FE 22            [24]  610 	ret
                            611 ;------------------------------------------------------------
   ...
   02FF 10 98 02      [24]  622 	jbc	_RI0,00112$
   0302 80 FB         [24]  623 	sjmp	00101$
   0304                     624 00112$:
                            625 ;	bootloader/util.c:60: return SBUF0;
   0304 85 99 82      [24]  626 	mov	dpl,_SBUF0
   0307 22            [24]  627 	ret
                            628 	.area CSEG    (CODE)
                            629 	.area CONST   (CODE)
