...
; This file was generated Sun Nov 24 17:43:03 2013
;--------------------------------------------------------
	.module printfl
...
_printf_start_capture_PARM_2:
	.ds 1
_printf_start_capture_buf_1_120:
	.ds 2
;--------------------------------------------------------
...
;buf                       Allocated with name '_printf_start_capture_buf_1_120'
;------------------------------------------------------------
...
_printf_start_capture:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_printf_start_capture_buf_1_120
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;buffer                    Allocated with name '_vprintfl_buffer_4_139'
;------------------------------------------------------------
